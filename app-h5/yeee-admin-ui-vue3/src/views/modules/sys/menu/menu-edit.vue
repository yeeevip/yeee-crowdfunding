      ...
      <el-row :gutter="20">
        ...
        <el-col :span="11">
          <el-form-item prop="pid" label="上级菜单" class="menu-list">
            <el-popover :visible="menuListVisible" @update:visible="menuListVisible = $event" placement="bottom-start" trigger="manual" width="300">
              <template #reference>
                <el-input v-model="dataForm.pnm" :readonly="true" placeholder="上级菜单" @click.stop="menuListVisible = true">
                  <template #suffix>
                    <el-icon v-if="dataForm.pid" @click.stop="menuListTreeSetDefaultHandle()" style="cursor: pointer; color: #999;">
                      <Close />
                    </el-icon>
                  </template>
                </el-input>
        ...
        <el-col :span="11" v-if="dataForm.type=== 0">
          <el-form-item prop="icon" label="图标" class="icon-list">
            <el-popover :visible="iconListVisible" @update:visible="iconListVisible = $event" placement="bottom-start" trigger="manual" popper-class="mod-menu-icon-popover" width="478">
              <template #reference>
                <el-input v-model="dataForm.icon" :readonly="true" placeholder="图标" @click.stop="iconListVisible = true"></el-input>
              </template>
  ...
  export default {
    ...
    methods: {
      ...
      menuListTreeCurrentChangeHandle (data) {
        console.log('Selected menu:', data)
